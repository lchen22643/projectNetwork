...
ggplot(data = mytestlarge$numInfections$n.infected, x = t, y = n.infected, geom = "line")
d1 <- data.frame(x1=mytestlarge$numInfections$t, y1=mytestlarge$numInfections$n.infected)#, g1=gl(3,10,labels=letters[1:3]))
d2 <- data.frame(x1=mytestcenter$numInfections$t, y1=mytestcenter$numInfections$n.infected)#, g1=gl(3,10,labels=letters[1:3]))

ggplot() + 
  geom_line(aes(x1, y1, colour=d1), d1) +  
  geom_line(aes(x2, y2, colour=d2), d2)


qplot(x1, y1, colour=g1, data=d1, geom="line")+geom_line(aes(x2, y2, colour=g2), d2) 

plotInfTimeGraph(docnet2,mytestlarge,c(1,100,500, 1000))
plotInfTimeGraph(docnet2,mytestcenter,c(1,100,500, 1000))
plotInfTimeGraph(docnet2,mytestbetween,c(1,100,500, 1000))
plotInfTimeGraph(docnet2,mytestPGRank,c(1,100,500, 1000))



plot(mytestcenter$numInfections$t,mytestcenter$numInfections$n.infected,type="l",col="red",ylim = c(0,40000))
par(new=TRUE)
plot(mytestlarge$numInfections$t,mytestlarge$numInfections$n.infected,type="l",axes = FALSE,xlab = "", ylab = "")
```
